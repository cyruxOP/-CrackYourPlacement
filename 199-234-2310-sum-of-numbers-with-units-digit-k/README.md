<h2> 199 234
2310. Sum of Numbers With Units Digit K</h2><hr><div><p>Given two integers <code>num</code> and <code>k</code>, consider a set of positive integers with the following properties:</p>
